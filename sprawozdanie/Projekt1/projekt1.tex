...
\caption{Wyniki symulacji dla dobranego eksperymentalnie regulatora PID: \\$K = 2,64$, $Ti=14,00$, $Td=3,36$, wyznaczony błąd $E=\num{19,6632}$}
\label{Z5manualPID}
\end{figure}
...
\caption{Wyniki symulacji dla dobranego eksperymentalnie regulatora DMC: \\$N=30$, $Nu=3$, $\lambda=\num{0,8}$, wyznaczony błąd $E=\num{15,6111}$}
\label{Z5manualDMC}
\end{figure}
...
\caption{Wyniki symulacji dla regulatora PID otrzymanego w wyniku optymalizacji:\\ $K=5,422910$, $Ti=8,551461$, $Td=3,914535$, wyznaczony błąd $E=\num{16,7418}$}
\label{Z6optimizedPID}
\end{figure}
...
\caption{Wyniki symulacji dla regulatora DMC otrzymanego w wyniku optymalizacji:\\ $N=33$, $Nu=4$, $\lambda=\num{0,018527}$, wyznaczony błąd $E=\num{15,5746}$}
