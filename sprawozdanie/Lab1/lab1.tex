...
\begin{figure}[ht]
\centering
\input{images/step_w_s_40}
\caption{Odpowiedź dla skoku z punktu pracy o $\triangle U = 10$}
\label{R1}
\end{figure}

\begin{figure}[ht]
\centering
\input{images/step_w_s_50}
\caption{Odpowiedź dla skoku z punktu pracy o $\triangle U = 20$}
\label{R2}
\end{figure}

\begin{figure}[ht]
\centering
\input{images/step_w_s_60}
\caption{Odpowiedź dla skoku z punktu pracy o $\triangle U = 30$}
\label{R3}
\end{figure}
